# Cool Ipsum
8th of 15 React Projects following [John Smilga](https://github.com/john-smilga/react-projects) tutorial from FreeCodeCamp course. 
This project was built using UseState to render a number of paragraphs chosen by the user at form. If the user sets 0 or less one paragraph is rendered and in case the user chooses more than the paragraphs we have in our data.js the page will render the maximum number as possible.
### 🛠 Tools:
- React
- JavaScript
- HTML5
